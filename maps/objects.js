...
let IndexTV = patient.hobbies.indexOf("TV")
patient.hobbies.splice(IndexTV,1);
...
let totalCapacity = ICUWard.room1.capacity + ICUWard.room2.capacity;
let totalPatients = ICUWard.room1.patients.length + ICUWard.room2.patients.length;
